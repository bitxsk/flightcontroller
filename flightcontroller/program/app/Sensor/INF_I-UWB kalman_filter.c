...
{
    state->x[0]    = init_x[0] = 0;
    state->x[1]    = init_x[1] = 0;
    state->p[0][0] = init_p[0][0] = 1;
    state->p[0][1] = init_p[0][1];
    state->p[1][0] = init_p[1][0];
    state->p[1][1] = init_p[1][1] = 1;
    //state->A       = {{1, 0.004}, {0, 1}};
    state->A[0][0] = 1;
    state->A[0][1] = 0.004;
    state->A[1][0] = 0;
    ...
    state->q[0]    = 10e-4;//×´Ì¬×ªÒÆÐ­·½²î¾ØÕó
    state->q[1]    = 10e-4;
    state->r       = 7.0404e-4;  /* estimated error convariance Á¿²âÔëÉù·½²î*/
}

float kalman2_state_x1 = 0;
