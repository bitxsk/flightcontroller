...
/********************************************************************/
int32 make_argv (char *cmdline, char *argv[])
{
...
/********************************************************************/
uint32 get_value (char *s, int32 *success, int32 base)
{
    uint32 value;
    char *p;
...
/********************************************************************/
void uif_cmd_help (int32 argc, char **argv)
{
    int32 index;
...
/********************************************************************/
void uif_cmd_set (int32 argc, char **argv)
{
    int32 index;
...
/********************************************************************/
void uif_cmd_show (int32 argc, char **argv)
{
    int32 index;
