...
//设置GPIO端口一位的输出
inline void GPIO_Output_b(GPIO_Type *ptx, uint32 lsb_num, uint8 data1)
{
...
//设置GPIO端口一位的翻转
inline void GPIO_Toggle_b(GPIO_Type *ptx, uint8 lsb_num)
{  
...
//取得GPIO口某一位的数据
inline uint8 GPIO_Input_b(GPIO_Type *ptx, uint8 lsb_num)
{  
