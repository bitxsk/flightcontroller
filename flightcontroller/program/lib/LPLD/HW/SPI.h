...
//SPI初始化函数
uint8 SPI_Init(SPI_InitTypeDef );
//SPI反初始化函数
uint8 SPI_Deinit(SPI_InitTypeDef );
//SPI使能外设中断
uint8 SPI_EnableIrq(SPI_InitTypeDef );
//SPI禁止外设中断
uint8 SPI_DisableIrq(SPI_InitTypeDef );
//SPI主机读写函数
uint8 SPI_Master_WriteRead(SPI_Type * ,uint8 ,uint8 ,uint8);
//SPI主机读函数
uint8 SPI_Master_Read(SPI_Type *);
//SPI主机写函数
void SPI_Master_Write(SPI_Type * ,uint8 ,uint8 ,uint8);
void SPI1_transferAttributeRegistersSwitch(int num);

extern int SPI1_PUSHR;
extern int SPI1_transferAttributeRegisters;
/********************************************************************/
