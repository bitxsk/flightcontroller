 ...
 *    1--配置成功
 */
uint8 PIT_Init(PIT_InitTypeDef pit_init_structure)
{ 
  //计算定时加载值
 ...
 *    无
 */
void PIT_Deinit(PIT_InitTypeDef pit_init_structure)
{ 
  PITx pitx = pit_init_structure.PIT_Pitx;
 ...
 *
 */
void PIT_EnableIrq(PIT_InitTypeDef pit_init_structure)
{
  PITx pitx = pit_init_structure.PIT_Pitx;
 ...
 *
 */
void PIT_DisableIrq(PIT_InitTypeDef pit_init_structure)
{
  PITx pitx = pit_init_structure.PIT_Pitx;
