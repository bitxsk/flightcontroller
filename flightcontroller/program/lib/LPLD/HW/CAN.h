...
//FlexCAN模块初始化函数
void CAN_Init(CAN_InitTypeDef );
//FlexCAN模块反初始化函数
void CAN_Deinit(CAN_InitTypeDef );
//FlexCAN模块中断使能
void CAN_EnableIrq(CAN_InitTypeDef );
//FlexCAN模块中断禁止
void CAN_DisableIrq(CAN_InitTypeDef );
//FlexCAN Msg缓冲区初始化
void CAN_InitMessageObject(CAN_MSGOBJ_InitTypeDef ,uint32 );
//FlexCAN 传输Msg函数
uint8 CAN_TransmitMessage(CAN_MSGOBJ_InitTypeDef, CAN_MessageFormat_TypeDef * );
//FlexCAN 接收中断处理函数
void CAN_ReceivedMessage(CAN_MSGOBJ_InitTypeDef , CAN_MessageFormat_TypeDef * );
