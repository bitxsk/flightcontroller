...
//RTC使能模块中断
#define RTC_EnableIrq()    enable_irq(RTC_IRQn)
//RTC禁止模块中断
#define RTC_DisableIrq()   disable_irq(RTC_IRQn)
//RTC获得实时秒计数函数
#define RTC_GetRealTime()  (RTC->TSR)
//RTC重新设置秒计数器函数
#define RTC_SetRealTime(TIME)     (RTC->TSR=TIME)
//RTC重新设置报警寄存器函数
#define RTC_SetAlarmTime(TIME)    (RTC->TAR=TIME)
//RTC关闭函数
