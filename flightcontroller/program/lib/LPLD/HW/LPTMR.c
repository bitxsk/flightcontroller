 ...
 *    1--配置成功
 */
uint8 LPTMR_Init(LPTMR_InitTypeDef lptmr_init_structure)
{
 ...
 *      无
 */
void LPTMR_DelayMs(uint16 period_ms)
{
  if(!period_ms)
    return;
