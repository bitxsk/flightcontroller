...
//    Locale       =  C
//    List file    =  
//        C:\Users\xsk19940910\Desktop\flightController-1\flightController-1\program\iar\FLASH\List\Navigation.s
//
///////////////////////////////////////////////////////////////////////////////
...
??Navigation_Init_1:
        ...
        DATA
// __absolute unsigned char static guard for Navigation_0
...
??update_2:
        ...
        VSUB.F32 S0,S16,S0
        VABS.F32 S1,S0
        VLDR.W   S2,??DataTable1_3  ;; 0x3e19999a
        VCMP.F32 S1,S2
        FMSTAT   
        BMI.N    ??update_3
        MOVS     R0,#+1
...
??update_9:
        ...
        VLDR     S1,[R6, #+156]
        VSUB.F32 S0,S0,S1
        VLDR.W   S1,??DataTable1_5  ;; 0x42c80001
        VCMP.F32 S0,S1
        FMSTAT   
        BLT.N    ??update_10
//   44   {
...
//   51     angleZ.Kp0 = angleZ.Kp0 * 0.95 + 1800 * 0.05;
        ...
        BL       __aeabi_dmul
        MOVS     R2,#+0
        LDR.N    R3,??DataTable1_6  ;; 0x40568000
        BL       __aeabi_dadd
        BL       __aeabi_d2f
        STR      R0,[R7, #+40]
//   52     angleZ.Kd0 = angleZ.Kd0 * 0.95 + 200 * 0.05;
        ...
        BL       __aeabi_dmul
        MOVS     R2,#+0
        LDR.N    R3,??DataTable1_7  ;; 0x40240000
        BL       __aeabi_dadd
        BL       __aeabi_d2f
        STR      R0,[R7, #+48]
//   53   }
...
//   56     angleZ.Kp0 = angleZ.Kp0 * 0.95 + 5000 * 0.05;
        ...
        BL       __aeabi_dmul
        MOVS     R2,#+0
        LDR.N    R3,??DataTable1_10  ;; 0x406f4000
        BL       __aeabi_dadd
        BL       __aeabi_d2f
        STR      R0,[R7, #+40]
//   57     angleZ.Kd0 = angleZ.Kd0 * 0.95 + 400 * 0.05;
        ...
        BL       __aeabi_dmul
        MOVS     R2,#+0
        LDR.N    R3,??DataTable1_11  ;; 0x40340000
        BL       __aeabi_dadd
        BL       __aeabi_d2f
        STR      R0,[R7, #+48]
//   58   }
...
//   63     angleToScreen = atan((UltrasoundUART->distance2 - UltrasoundUART->distance3) / 0.48f) * 57.296f;
        ...
        BL       _ZN17CoordinateElementcvfEv
        VSUB.F32 S0,S16,S0
        VLDR.W   S1,??DataTable1_12  ;; 0x3ef5c28f
        VDIV.F32 S16,S0,S1
        VMOV.F32 S0,S16
        BL       atanf
        VLDR.W   S1,??DataTable1_13  ;; 0x42652f1b
        VMUL.F32 S0,S0,S1
        VSTR     S0,[R6, #+140]
//   64     angleFilter.setParameter((abs(MPU6000.gyro_z) * 90 + 800), 80);
        LDR.N    R7,??DataTable1_14
        VLDR     S17,[R7, #+68]
        VABS.F32 S1,S17
        MOVS     R1,#+80
        VLDR.W   S2,??DataTable1_15  ;; 0x42b40000
        VLDR.W   S0,??DataTable1_16  ;; 0x44480000
        VMLA.F32 S0,S1,S2
        MOVS     R0,R6
        BL       _ZN11CJumpFilter12setParameterEfi
...
//   66     angleToScreen_CF = (angleToScreen_CF + MPU6000.gyro_z * 0.002) * 0.995f + angleToScreenJumpF * 0.005;
        ...
        LDR      R0,[R7, #+68]
        BL       __aeabi_f2d
        LDR.N    R2,??DataTable1_17  ;; 0xd2f1a9fc
        LDR.N    R3,??DataTable1_18  ;; 0x3f60624d
        BL       __aeabi_dmul
        MOVS     R2,R4
        MOVS     R3,R5
        BL       __aeabi_dadd
        MOVS     R2,#+1073741824
        LDR.N    R3,??DataTable1_19  ;; 0x3fefd70a
        BL       __aeabi_dmul
        MOVS     R4,R0
        MOVS     R5,R1
        LDR      R0,[R6, #+144]
        BL       __aeabi_f2d
        LDR.N    R2,??DataTable1_20  ;; 0x47ae147b
        LDR.N    R3,??DataTable1_21  ;; 0x3f747ae1
        BL       __aeabi_dmul
        MOVS     R2,R4
        MOVS     R3,R5
        BL       __aeabi_dadd
