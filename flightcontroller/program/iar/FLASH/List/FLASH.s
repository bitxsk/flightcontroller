...
//    Locale       =  C
//    List file    =  
//        C:\Users\xsk19940910\Desktop\flightController-1\flightController-1\program\iar\FLASH\List\FLASH.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  267     FTFE->FCCOB8 = (uint8_t)(*((uint8_t*)DataSrcPtr+7));
        LDRB     R6,[R3, #+7]
        LDR.N    R7,??DataTable2_11  ;; 0x4002000f
        STRB     R6,[R7, #+0]
//  268     FTFE->FCCOB9 = (uint8_t)(*((uint8_t*)DataSrcPtr+6));
        LDRB     R6,[R3, #+6]
        LDR.N    R7,??DataTable2_12  ;; 0x4002000e
        STRB     R6,[R7, #+0]
//  269     FTFE->FCCOBA = (uint8_t)(*((uint8_t*)DataSrcPtr+5));
        LDRB     R6,[R3, #+5]
        LDR.N    R7,??DataTable2_13  ;; 0x4002000d
        STRB     R6,[R7, #+0]
//  270     FTFE->FCCOBB = (uint8_t)(*((uint8_t*)DataSrcPtr+4));
        LDRB     R6,[R3, #+4]
        LDR.N    R7,??DataTable2_14  ;; 0x4002000c
        STRB     R6,[R7, #+0]
