...
//    Locale       =  C
//    List file    =  
//        C:\Users\xsk19940910\Desktop\flightController-1\flightController-1\program\iar\FLASH\List\FTM.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  925         PORTA->PCR[0] = PORTA->PCR[0] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        LDR.W    R0,??DataTable11  ;; 0x40049000
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
//  927         PORTD->PCR[5] = PORTD->PCR[5] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        LDR.W    R0,??DataTable11_1  ;; 0x4004c014
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x400
        STR      R4,[R0, #+0]
...
//  933         PORTA->PCR[1] = PORTA->PCR[1] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        LDR.W    R0,??DataTable11_2  ;; 0x40049004
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
//  935         PORTD->PCR[6] = PORTD->PCR[6] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        LDR.W    R0,??DataTable13  ;; 0x4004c018
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x400
        STR      R4,[R0, #+0]
...
//  941         PORTA->PCR[2] = PORTA->PCR[2] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        LDR.W    R0,??DataTable15  ;; 0x40049008
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
//  943         PORTD->PCR[7] = PORTD->PCR[7] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        LDR.W    R0,??DataTable15_1  ;; 0x4004c01c
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x400
        STR      R4,[R0, #+0]
...
??FTM_PinInit_0:
        LDR.W    R0,??DataTable10_12  ;; 0x40039000
        CMP      R3,R0
...
//  957         PORTA->PCR[8] = PORTA->PCR[8] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        LDR.W    R0,??DataTable15_2  ;; 0x40049020
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
//  959         PORTA->PCR[12] = PORTA->PCR[12] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        LDR.W    R0,??DataTable15_3  ;; 0x40049030
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
//  961         PORTB->PCR[0] = PORTB->PCR[0] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        LDR.W    R0,??DataTable15_4  ;; 0x4004a000
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
//  967         PORTA->PCR[9] = PORTA->PCR[9] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        LDR.W    R0,??DataTable15_5  ;; 0x40049024
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
//  969         PORTA->PCR[13] = PORTA->PCR[13] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        LDR.W    R0,??DataTable15_6  ;; 0x40049034
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
//  971         PORTB->PCR[1] = PORTB->PCR[1] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        LDR.W    R0,??DataTable15_7  ;; 0x4004a004
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
??FTM_PinInit_36:
        LDR.W    R0,??DataTable10_13  ;; 0x400b8000
        CMP      R3,R0
...
// 1004         PORTA->PCR[10] = PORTA->PCR[10] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        LDR.W    R0,??DataTable15_8  ;; 0x40049028
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
// 1006         PORTB->PCR[18] = PORTB->PCR[18] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        LDR.W    R0,??DataTable15_9  ;; 0x4004a048
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
// 1012         PORTA->PCR[11] = PORTA->PCR[11] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        LDR.W    R0,??DataTable15_10  ;; 0x4004902c
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
// 1014         PORTB->PCR[19] = PORTB->PCR[19] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        LDR.W    R0,??DataTable15_11  ;; 0x4004a04c
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
??FTM_PinInit_57:
        LDR.W    R0,??DataTable15_12  ;; 0x400b9000
        CMP      R3,R0
...
// 1046         PORTE->PCR[5] = PORTE->PCR[5] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        LDR.W    R0,??DataTable15_13  ;; 0x4004d014
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x600
        STR      R4,[R0, #+0]
...
// 1048         PORTD->PCR[0] = PORTD->PCR[0] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        LDR.W    R0,??DataTable15_14  ;; 0x4004c000
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x400
        STR      R4,[R0, #+0]
...
// 1054         PORTE->PCR[6] = PORTE->PCR[6] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        LDR.W    R0,??DataTable15_15  ;; 0x4004d018
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x600
        STR      R4,[R0, #+0]
...
// 1056         PORTD->PCR[1] = PORTD->PCR[1] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        LDR.W    R0,??DataTable15_16  ;; 0x4004c004
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x400
        STR      R4,[R0, #+0]
...
// 1062         PORTE->PCR[7] = PORTE->PCR[7] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        LDR.W    R0,??DataTable15_17  ;; 0x4004d01c
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x600
        STR      R4,[R0, #+0]
...
// 1064         PORTD->PCR[2] = PORTD->PCR[2] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        LDR.W    R0,??DataTable15_18  ;; 0x4004c008
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x400
        STR      R4,[R0, #+0]
...
// 1070         PORTE->PCR[8] = PORTE->PCR[8] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        LDR.W    R0,??DataTable15_19  ;; 0x4004d020
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x600
        STR      R4,[R0, #+0]
...
// 1072         PORTD->PCR[3] = PORTD->PCR[3] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        LDR.W    R0,??DataTable15_20  ;; 0x4004c00c
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x400
        STR      R4,[R0, #+0]
...
// 1078         PORTE->PCR[9] = PORTE->PCR[9] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        LDR.W    R0,??DataTable15_21  ;; 0x4004d024
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x600
        STR      R4,[R0, #+0]
...
// 1080         PORTC->PCR[8] = PORTC->PCR[8] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        LDR.W    R0,??DataTable15_22  ;; 0x4004b020
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
// 1086         PORTE->PCR[10] = PORTE->PCR[10] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        LDR.W    R0,??DataTable15_23  ;; 0x4004d028
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x600
        STR      R4,[R0, #+0]
...
// 1088         PORTC->PCR[9] = PORTC->PCR[9] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        LDR.W    R0,??DataTable15_24  ;; 0x4004b024
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
// 1094         PORTE->PCR[11] = PORTE->PCR[11] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        LDR.W    R0,??DataTable15_25  ;; 0x4004d02c
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x600
        STR      R4,[R0, #+0]
...
// 1096         PORTC->PCR[10] = PORTC->PCR[10] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        LDR.W    R0,??DataTable15_26  ;; 0x4004b028
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
// 1102         PORTE->PCR[12] = PORTE->PCR[12] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(6); 
        LDR.W    R0,??DataTable15_27  ;; 0x4004d030
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x600
        STR      R4,[R0, #+0]
...
// 1104         PORTC->PCR[11] = PORTC->PCR[11] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        LDR.W    R0,??DataTable15_28  ;; 0x4004b02c
        LDR      R4,[R0, #+0]
        BICS     R4,R4,#0x700
        ORRS     R4,R4,#0x300
        STR      R4,[R0, #+0]
...
// 1127   if(ftmx == FTM0)
        LDR.W    R0,??DataTable15_29  ;; 0x40038000
        CMP      R2,R0
...
??FTM_PinDeinit_1:
        LDR.W    R0,??DataTable15_30  ;; 0x4004900c
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_10:
        LDR.W    R0,??DataTable15_31  ;; 0x4004b004
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1024
...
??FTM_PinDeinit_3:
        LDR.W    R0,??DataTable15_32  ;; 0x40049010
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_13:
        LDR.W    R0,??DataTable15_33  ;; 0x4004b008
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1024
...
??FTM_PinDeinit_2:
        LDR.W    R0,??DataTable15_34  ;; 0x40049014
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_15:
        LDR.W    R0,??DataTable15_35  ;; 0x4004b00c
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1024
...
??FTM_PinDeinit_5:
        LDR.W    R0,??DataTable15_36  ;; 0x40049018
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_17:
        LDR.W    R0,??DataTable15_37  ;; 0x4004b010
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1024
...
??FTM_PinDeinit_4:
        LDR.W    R0,??DataTable15_38  ;; 0x4004901c
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_19:
        LDR.W    R0,??DataTable15_39  ;; 0x4004c010
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1024
...
??FTM_PinDeinit_43:
        LDR.N    R0,??DataTable15_6  ;; 0x40049034
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1792
...
??FTM_PinDeinit_44:
        LDR.N    R0,??DataTable15_7  ;; 0x4004a004
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1536
...
??FTM_PinDeinit_47:
        LDR.N    R0,??DataTable15_8  ;; 0x40049028
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_52:
        LDR.N    R0,??DataTable15_9  ;; 0x4004a048
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_48:
        LDR.N    R0,??DataTable15_10  ;; 0x4004902c
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_54:
        LDR.N    R0,??DataTable15_11  ;; 0x4004a04c
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_46:
        LDR.N    R0,??DataTable15_12  ;; 0x400b9000
        CMP      R2,R0
...
??FTM_PinDeinit_61:
        LDR.N    R0,??DataTable15_13  ;; 0x4004d014
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1536
...
??FTM_PinDeinit_70:
        LDR.N    R0,??DataTable15_14  ;; 0x4004c000
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1024
...
??FTM_PinDeinit_63:
        LDR.N    R0,??DataTable15_15  ;; 0x4004d018
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1536
...
??FTM_PinDeinit_72:
        LDR.N    R0,??DataTable15_16  ;; 0x4004c004
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1024
...
??FTM_PinDeinit_62:
        LDR.N    R0,??DataTable15_17  ;; 0x4004d01c
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1536
...
??FTM_PinDeinit_74:
        LDR.N    R0,??DataTable15_18  ;; 0x4004c008
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1024
...
??FTM_PinDeinit_65:
        LDR.N    R0,??DataTable15_19  ;; 0x4004d020
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1536
...
??FTM_PinDeinit_76:
        LDR.N    R0,??DataTable15_20  ;; 0x4004c00c
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1024
...
??FTM_PinDeinit_64:
        LDR.N    R0,??DataTable15_21  ;; 0x4004d024
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1536
...
??FTM_PinDeinit_78:
        LDR.N    R0,??DataTable15_22  ;; 0x4004b020
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_67:
        LDR.N    R0,??DataTable15_23  ;; 0x4004d028
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1536
...
??FTM_PinDeinit_80:
        LDR.N    R0,??DataTable15_24  ;; 0x4004b024
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_66:
        LDR.N    R0,??DataTable15_25  ;; 0x4004d02c
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1536
...
??FTM_PinDeinit_82:
        LDR.N    R0,??DataTable15_26  ;; 0x4004b028
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
...
??FTM_PinDeinit_68:
        LDR.N    R0,??DataTable15_27  ;; 0x4004d030
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+1536
...
??FTM_PinDeinit_84:
        LDR.N    R0,??DataTable15_28  ;; 0x4004b02c
        LDR      R3,[R0, #+0]
        ANDS     R3,R3,#0x700
        CMP      R3,#+768
