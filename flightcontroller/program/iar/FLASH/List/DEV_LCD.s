...
//    Locale       =  C
//    List file    =  
//        C:\Users\xsk19940910\Desktop\flightController-1\flightController-1\program\iar\FLASH\List\DEV_LCD.s
//
///////////////////////////////////////////////////////////////////////////////
...
_ZN26_INTERNAL_9_DEV_LCD_c_PreX9LCD_ResetEv:
        PUSH     {R4,LR}
//  197   LCD_CLR_RST;
        LDR.N    R4,??DataTable5_3  ;; 0x43fe183c
        MOVS     R0,#+0
        STR      R0,[R4, #+0]
...
??LCD_FillBackground_0:
        LDR.W    R0,??DataTable20_1  ;; 0x5dc00
        CMP      R6,R0
...
// 1156       LCD_GRAM[MAX_X*MAX_Y - (j-1)*MAX_Y - (i)] = Color;
        ...
        LDR      R12,[R4, #+0]
        LDR.W    LR,??DataTable20_1  ;; 0x5dc00
        MOV      R8,R6
...
// 1179     LCD_GRAM[MAX_X*MAX_Y - (x0+i-1)*MAX_Y - (y0)] = Color;
        ...
        LDR      R6,[R4, #+0]
        LDR.N    R7,??DataTable20_1  ;; 0x5dc00
        MOVS     R4,R5
        UXTH     R4,R4            ;; ZeroExt  R4,R4,#+16,#+16
        UXTAH    R12,R4,R0
        SUBS     R12,R12,#+1
