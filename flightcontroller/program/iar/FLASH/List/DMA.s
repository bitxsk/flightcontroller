///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.30.1.114/W32 for ARM        31/Aug/2018  16:56:46
...
//    Command line =  
//        -f C:\Users\XSK199~1\AppData\Local\Temp\EW53FB.tmp
//        (C:\Users\xsk19940910\Desktop\flightController-1\flightController-1\program\lib\LPLD\HW\DMA.c
...
//    Locale       =  C
//    List file    =  
//        C:\Users\xsk19940910\Desktop\flightController-1\flightController-1\program\iar\FLASH\List\DMA.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  600   if( DMA0->INT & 0x1u<<0)
        LDR.W    R4,??DataTable19_10  ;; 0x40008024
        LDR      R0,[R4, #+0]
        LSLS     R0,R0,#+31
...
//  631   if( DMA0->INT & 0x1u<<1)
        LDR.N    R4,??DataTable19_10  ;; 0x40008024
        LDR      R0,[R4, #+0]
        LSLS     R0,R0,#+30
